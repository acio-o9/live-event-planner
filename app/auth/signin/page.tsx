...
export default function SignInPage() {
  const [nickname, setNickname] = useState("maru");
        ...
        {process.env.NODE_ENV !== "production" && (
          <form onSubmit={handleDevLogin} className="space-y-3">
            ...
            <button
              ...
              className="w-full bg-amber-500 text-white py-2 rounded font-medium text-sm hover:bg-amber-600 disabled:opacity-50"
            >
              {isLoading ? "ログイン中..." : "開発用でログイン"}
            </button>
          </form>
        )}
